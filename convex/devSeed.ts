...
import { parseBotMetadata, parseFrontmatter } from './lib/skills'
...
\`\`\`bash
padel  # On PATH (bot plugin bundle)
\`\`\`
...
`,
    ...
    rawSkillMd: `---
name: gohome
description: Use when Bot needs to test or operate GoHome via gRPC discovery, metrics, and Grafana.
---
