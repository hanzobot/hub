...
Skills can post Discord embeds when skills are published or highlighted.
...
- `SITE_URL` (optional): Base site URL for links (default `https://skills.com`).
  ...
  "embeds": [
    {
      ...
      "url": "https://skills.com/owner/demo-skill",
      "fields": [
